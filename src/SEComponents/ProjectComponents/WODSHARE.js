    ...
    return (
      <div>
        ...
        <PopPop position="centerCenter"
          ...
          WODSHARE is a web application aimed at solving the current standard (google/excel sheets) that personal trainers use for training athletes online or in a gym setting. It allows coaches to monitor athlete’s progress, assign workout programs and easily manage working with several clients.
          </p>
