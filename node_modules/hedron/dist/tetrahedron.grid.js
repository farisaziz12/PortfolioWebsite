(function (global, factory) {
	...
	(factory((global.tetrahedron = global.tetrahedron || {}, global.tetrahedron.grid = {}),global.styled,global.React));
	...
	*/
	...
	var breakpoints = function breakpoints(props) {
	  ...
	  return Object.keys(props.breakpoints).map(function (id) {
	    return props[id] && [styled.css(_templateObject2, props.breakpoints[id][0], props.breakpoints[id][1], utils.generateStyles(props[id]))];
	  });
	};
	...
	var flex = function flex(_ref2) {
	  var flex = _ref2.flex,
	      ...
	      valign = _ref2.valign,
	      halign = _ref2.halign,
	      shiftLeft = _ref2.shiftLeft,
	      shiftRight = _ref2.shiftRight,
	      shiftUp = _ref2.shiftUp,
	      shiftDown = _ref2.shiftDown;
	...
	var Stylable = function Stylable(element) {
	  return styled__default(element)(generateStyles);
	};
	 ...
	 * are `Box` or `Bounds`.
	 */
	var Bounds = styled__default(Stylable("div"))(_templateObject$1, function (props) {
	...
	var withBreakpoints = function withBreakpoints(WrappedComponent) {
	  ...
	  return (
	    ...
	    _temp = _class = function (_Component2) {
	      inherits(GridProvider, _Component2);

	      function GridProvider() {
	        classCallCheck(this, GridProvider);
	        return possibleConstructorReturn(this, (GridProvider.__proto__ || Object.getPrototypeOf(GridProvider)).apply(this, arguments));
	      }

	      createClass(GridProvider, [{
	        key: "render",
	        value: function render() {
	...
	var Box = styled__default(Stylable("div"))(_templateObject$2, function (props) {
	...
	var index = { Provider: Provider, Bounds: Bounds, Box: Box$1 };
