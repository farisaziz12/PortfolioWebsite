...
var breakpoints = function breakpoints(props) {
  ...
  return Object.keys(props.breakpoints).map(function (id) {
    return props[id] && [css(_templateObject2, props.breakpoints[id][0], props.breakpoints[id][1], utils.generateStyles(props[id]))];
  });
};
...
var Stylable = function Stylable(element) {
  return styled(element)(generateStyles);
};
 ...
 * are `Box` or `Bounds`.
 */
var Bounds = styled(Stylable("div"))(_templateObject$1, function (props) {
...
var Box = styled(Stylable("div"))(_templateObject$2, function (props) {
