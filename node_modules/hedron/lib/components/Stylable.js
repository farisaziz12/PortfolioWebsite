...
var Stylable = function Stylable(element) {
  return (0, _styledComponents2.default)(element)(_helpers.generateStyles);
};
...
Stylable.propTypes = {
  ...
  fontWeight: _propTypes2.default.oneOf([_propTypes2.default.string, _propTypes2.default.number]),
